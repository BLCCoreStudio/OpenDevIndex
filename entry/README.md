...
- Create encrypted point-to-point tunnels
- Build site-to-site VPN links
...
- Kind: `protocol`
- Domains: `cryptography`, `networking`, `security`
...
- Repository: https://github.com/WireGuard/wireguard-tools
