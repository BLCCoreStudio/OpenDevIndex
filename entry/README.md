...
scikit-learn is indexed as a **library**. Its stable OpenDevIndex address is `ai/scikit-learn`; taxonomy facets are kept separate from that address so classification can improve without breaking links.
...
- Build preprocessing and feature pipelines
- Evaluate and tune predictive models

## Key points

- Estimator APIs are designed to compose consistently
