...
- Reviewed `tool/jq` against the current OpenDevIndex catalog and taxonomy.
- Recorded canonical kind `tool` and domain facets: cli, data, developer-tools.
...
- Added `tool/jq` to the curated OpenDevIndex v0.1 catalog.
