...
- Reviewed `cloud/envoy` against the current OpenDevIndex catalog and taxonomy.
- Recorded canonical kind `tool` and domain facets: cloud, networking.
...
- Added `cloud/envoy` to the curated OpenDevIndex v0.1 catalog.
