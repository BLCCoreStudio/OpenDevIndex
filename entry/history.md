...
- Reviewed `cloud/istio` against the current OpenDevIndex catalog and taxonomy.
- Recorded canonical kind `platform` and domain facets: cloud, networking.
...
- Added `cloud/istio` to the curated OpenDevIndex v0.1 catalog.
