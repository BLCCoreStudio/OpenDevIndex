...
- Reviewed `ai/llamaindex` against the current OpenDevIndex catalog and taxonomy.
- Recorded canonical kind `framework` and domain facets: ai, data.
...
- Added `ai/llamaindex` to the curated OpenDevIndex v0.1 catalog.
