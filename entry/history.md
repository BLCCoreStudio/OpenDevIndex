...
- Reviewed `tool/cmake` against the current OpenDevIndex catalog and taxonomy.
- Recorded canonical kind `tool` and domain facets: build, developer-tools.
...
- Added `tool/cmake` to the curated OpenDevIndex v0.1 catalog.
