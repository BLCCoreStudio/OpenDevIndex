...
- Reviewed `ai/onnx` against the current OpenDevIndex catalog and taxonomy.
- Recorded canonical kind `standard` and domain facets: ai, machine-learning.
...
- Added `ai/onnx` to the curated OpenDevIndex v0.1 catalog.
