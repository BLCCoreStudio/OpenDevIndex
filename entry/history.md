...
- Reviewed `protocol/grpc` against the current OpenDevIndex catalog and taxonomy.
- Recorded canonical kind `protocol` and domain facets: networking.
...
- Added `protocol/grpc` to the curated OpenDevIndex v0.1 catalog.
